...
L.BarChartMarker = L.ChartMarker.extend({
    ...
    _loadComponents: function() {
        ...
        y = 0;
        //TODO: Modificado parq que el objeto displayOptions sea pasado y poder usar el objeto fillcolor para cada una de las barras del marcador
...
L.ChartDataLayer = L.DataLayer.extend({
    ...
    _getLayer: function(latLng, layerOptions, record) {
      ...
      //TODO: Modificado parq que el objeto displayOptions sea pasado y poder usar el objeto fillcolor para cada una de las barras del marcador
        options.displayOptions = this.options.displayOptions;
        ...
        if (latLng) {
            ...
            for (var key in marker._layers) {
            	var indice=marker._layers[key].options.key;
            	if (marker._layers[key].options.displayOptions){
	            	var valor=marker._layers[key].options.data[indice];
	            	var color=marker._layers[key].options.displayOptions[indice].fillColor;
	            	if (color) { // Evitamos que el elemento no exista
	            		marker._layers[key].options.fillColor=color.evaluate(valor);
	            	}
            	}
            }
        }
